...
// Security config for the sample app. The JWT filter, entry points, and logging all come
// from the starter — this class just wires them in and declares which endpoints need what roles.
@Configuration
@EnableWebSecurity
